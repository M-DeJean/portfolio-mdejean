    ...
    render() {
        return (
            <div id="about" className="group">
                ...
                <p>
                    Before I even knew the definition of software engineering, I found my 12-year-old self hosting a gaming forum with the use of PHP. This is where I found my passion. Since then, I have become a computer science major at the University of California, Davis, and a graduate from Thinkful's immersive software engineering program. I enjoy working with CSS, HTML, JavaScript, React, Node, and PostgreSQL. <br />
                    When my eyes aren't glued to a computer screen, they're more than likely glued to the TV screen with an Xbox controller in hand. Whether it's completing a mission in a multiplayer game, playing a sport, or creating a React project, I believe that the key to success is to surround yourself with other like-minded individuals.
                </p>
            </div>
        )
    }
